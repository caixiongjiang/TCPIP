...
- [pipe1.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch11/pipe1.c)
...
- [pipe2.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch11/pipe2.c)
...
- [pipe3.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch11/pipe3.c)
...
下面对第 10 章的 [echo_mpserv.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/echo_mpserv.c) 进行改进，添加一个功能：

> 将回声客户端传输的字符串按序保存到文件中

实现该任务将创建一个新进程，从向客户端提供服务的进程读取字符串信息，下面是代码：

- [echo_storeserv.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch11/echo_storeserv.c)
...
此服务端配合第 10 章的客户端 [echo_mpclient.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/echo_mpclient.c) 使用，运行结果如下图:
