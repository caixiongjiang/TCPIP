...
当时说过调用 shutdown 函数的基于半关闭的 EOF 传递方法。第十章的 [echo_mpclient.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/echo_mpclient.c) 添加了半关闭的相关代码。但是还没有讲采用 fdopen 函数怎么半关闭。那么是否是通过 fclose 函数关闭流呢？我们先试试

下面是服务端和客户端码：

- [sep_clnt.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch16/sep_clnt.c)
- [sep_serv.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch16/sep_serv.c)
...
- [dup.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch16/dup.c)
...
下面更改 [sep_clnt.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch16/sep_clnt.c) 和 [sep_serv.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch16/sep_serv.c) 可以使得让它正常工作，正常工作是指通过服务器的半关闭状态接收客户端最后发送的字符串。

下面是代码：

- [sep_serv2.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch16/sep_serv2.c)

这个代码可以与 [sep_clnt.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch16/sep_clnt.c) 配合起来使用，编译过程和上面一样，运行结果为：
