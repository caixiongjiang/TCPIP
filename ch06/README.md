...
- [uecho_client.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch06/uecho_client.c)
- [uecho_server.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch06/uecho_server.c)
...
- [bound_host1.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch06/bound_host1.c)
- [bound_host2.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch06/bound_host2.c)
...
下面的例子把之前的 [uecho_client.c](https://github.com/caixiongjiang/TCPIP/master/ch06/uecho_client.c) 程序改成了基于已连接 UDP 的套接字的程序，因此可以结合 [uecho_server.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch06/uecho_server.c) 程序运行。代码如下：

- [uecho_con_client.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch06/uecho_con_client.c)
...
代码：
* [uchar_server.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch06/homework/uchar_server.c)
* [uchar_client.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch06/homework/uchar_client.c)
