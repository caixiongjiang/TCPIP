...
- [fork.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/fork.c)
...
- [zombie.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/zombie.c)
...
- [wait.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/wait.c)
...
- [waitpid.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/waitpid.c)
...
- [signal.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/signal.c)
...
- [sigaction.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/sigaction.c)
...
- [remove_zomebie.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/remove_zomebie.c)
...
下面是基于多进程实现的并发的回声服务器的服务端，可以结合第四章的 [echo_client.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch04/echo_client.c) 回声客户端来运行。

- [echo_mpserv.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/echo_mpserv.c)
...
3. **创建子进程时复制父进程所有内容，此时复制对象也包含套接字文件描述符。编写程序验证赋值的文件描述符整数值是否与原文件描述符数值相同。**
   ...
   答：代码为多进程服务器修改而来，代码：[test_server.c](https://github.com/caixiongjiang/TCPIP/blob/master/ch10/test_server.c)
